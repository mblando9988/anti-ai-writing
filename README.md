...
Runs every corpus item through the binary and prints precision/recall. Last run was 1.00/0.95 on 407 examples. `test/ab_eval.py` compares it against a plain keyword baseline on a held-out split.
